    ...
    <div className="dds-why-safe-points">
      <div className="dds-why-safe-point">
        <picture className="dds-why-safe-image">
          <img src="/security-approved-models.webp" alt="Только одобренные модели" />
        </picture>
      ...
      <div className="dds-why-safe-point">
        <picture className="dds-why-safe-image">
          <img src="/security-private-cloud.webp" alt="Ваш контур, ваша юрисдикция" />
        </picture>
        <div className="dds-why-safe-point-text">
      ...
      <div className="dds-why-safe-point">
        <picture className="dds-why-safe-image">
          <img src="/security-ai-stack.webp" alt="Собственный AI-стек" />
        </picture>
        <div className="dds-why-safe-point-text">
